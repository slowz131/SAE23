...
<ul>
    ...
    <br>
    <li>
        <a href="supprimer_salle.php" class="action-link action-link--danger">Supprimer une salle</a>
    </li>
    <br>
    <li>
        <a href="supprimer_capteur.php" class="action-link action-link--danger"> Supprimer un capteur</a>
    </li>
</ul>
